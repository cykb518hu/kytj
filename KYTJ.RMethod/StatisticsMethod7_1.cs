...
namespace KYTJ.RMethod
{
    ...
    /// 两样本比较的U检验
    /// </summary>
    public class StatisticsMethod7_1 : StatisticsMethod
    {
        public StatisticsMethod7_1()
        {
        ...
        private bool IsValid()
        {
            ...
            res = res && (!string.IsNullOrEmpty(AlternativeHypothesis));
            return res;
        }
