<template>
    <div v-if="easyFlowVisible" style="height: calc(100vh);">
        ...
        <flow-dataSource v-if="flowDataSourceVisible" ref="flowDataSource"></flow-dataSource>
...
<script>
    ...
    import flowDataSource from '@/components/ef/flow_dataSource'
            ...
            dbclickNode(nodeId){
                ...
                switch(nodeType){
                  case "dataSource":
                    ...
                    this.$nextTick(function () {
                          this.$refs.flowDataSource.init(nodeId)
                       });
                     break;
