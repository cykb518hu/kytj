                    ...
                    <el-col :span="12">
                     ...
                     <el-col :span="12">
                          ...
                          <el-form label-width="150px" size="mini">
                              ...
                              <el-form-item label="使用GEE-家系编号:" >
                                 <el-select v-model="familySnField" placeholder="请选择..." >
                                    <el-option
                                        v-for="item in dataColumns"
                                        :key="item.id"
                                        :label="item.rem"
                              ...
                              <el-form-item label="使用GEE-GEE Type:" >
                                 <el-select v-model="geeType" placeholder="请选择..." >
                                    <el-option
                                        v-for="item in geeTypes"
                                        :key="item.code"
                                        :label="item.name"
                                        :value="item.code">
                                      </el-option>
                                  ...
                                  <el-form-item label="" >
                                  <el-checkbox label="snp Data(0=AA 1=AB 2=BB)" name="type" v-model="hasSnp"></el-checkbox>
                              </el-form-item>
                               <el-form-item label="调整变量:" >
                                 <el-select v-model="adjustField" placeholder="请选择..." >
                                    <el-option
                                        v-for="item in dataColumns"
                                        :key="item.id"
                                        :label="item.rem"
...
export default {
  ...
  methods: {
       ...
       getDictionaryDTOs(){
          ...
          getDictionaryDTOsForGee(){
          this.$axios
            .get("dataFlow/GetDictionaryDTOs?type=gee.type")
            .then((res) => {
              if (res.data && res.data.success) {
                this.geeTypes=res.data.data;
       ...
       handleSelectionChange(val) {
        ...
        Calculate(){
            if(this.multipleSelection.length==0){
             this.$message.warning("基因变量不能为空");
             return;
          }
          if(this.multipleSelection.length>2){
             this.$message.warning("基因变量不能超过2个");
             return;
          }
          ...
          param.adjustFields.push(this.adjustField);
          param.snField=this.snField;
          param.familySnField=this.familySnField;
          param.geeType=this.geeType;
          param.hasSnp=this.hasSnp;
