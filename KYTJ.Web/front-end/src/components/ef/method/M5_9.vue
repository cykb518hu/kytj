                    ...
                    <el-col :span="12">
                     ...
                     <el-col :span="12">
                          ...
                          <el-form label-width="150px">
                              ...
                              <el-form-item label="数据类型与分割方法:" >
                                <el-select v-model="dataType_ClassMethod" placeholder="请选择.." >
                                    <el-option label="1.分类型(class)" value="1"></el-option>
                                     <el-option label="2.连续型(anova)" value="2"></el-option>
                                     <el-option label="3.计数型(poission)" value="3"></el-option>
                                </el-select>
                              </el-form-item>
                              <el-form-item>
       ...
       handleSelectionChange(val) {
        ...
        Calculate(){
          ...
          if(this.multipleSelection.length>5){
           ...
           if(this.dataType_ClassMethod===""){
             this.$message.warning("请选择数据类型或分割方法");
             return;
          }
          ...
          param.dataType_ClassMethod=this.dataType_ClassMethod;
