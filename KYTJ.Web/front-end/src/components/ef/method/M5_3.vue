                     ...
                     <el-col :span="12">
                          ...
                          <el-form label-width="120px">
                              ...
                              <el-form-item label="联系函数:" >
                               ...
                               <el-form-item label="分层变量:" >
                                <el-select v-model="geeField" placeholder="请选择分层变量" >
                                      <el-option
                                        v-for="item in dataColumns"
                                        :key="item.id"
                                        :label="item.rem"
                                ...
                                <el-select v-model="flField" placeholder="请选择研究对象编号" >
                                      <el-option
                                        v-for="item in dataColumns"
                                        :key="item.id"
                                        :label="item.rem"
       ...
       handleSelectionChange(val) {
        ...
        Calculate(){
          ...
          if(this.multipleSelection.length>5){
           ...
           if(this.geeField===""){
             this.$message.warning("Gee编号变量不能为空");
             return;
          }
          var param = {};
          let ids=[];
          ...
          param.geeField=this.geeField;
          param.flField=this.flField;
