                    ...
                    <el-col :span="12">
                     ...
                     <el-col :span="12">
                          ...
                          <el-form label-width="120px">
                              <el-form-item label="选择组编号变量:" >
                                <el-select v-model="groupingField" placeholder="请选择选择组编号变量变量" >
                                      <el-option
       ...
       handleSelectionChange(val) {
        ...
        Calculate(){
           ...
           if(this.multipleSelection.length>5){
             this.$message.warning("分析变量不能超过5个");
             return;
          }
            if(this.groupingField<=0){
             this.$message.warning("组编号变量不能为空");
             return;
          }
          var param = {};
          let ids=[];
