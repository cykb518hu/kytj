                     ...
                     <el-col :span="12">
                          ...
                          <el-form label-width="120px">
                              ...
                              <el-form-item label="联系函数:" >
                               ...
                               <el-form-item label="曲线拟合自变量:" >
                                <el-select v-model="curveFields" placeholder="请选择曲线拟合自变量" >
                                      <el-option
                                        v-for="item in dataColumns"
                                        :key="item.id"
                                        :label="item.rem"
                              ...
                              <el-form-item label="研究对象或组编号变量(ID):" >
                                 <!-- <div style="margin-top:5%;"><input type ="checkbox" alt="sj" /> 随机截距效应</div> meiyong dao -->
       ...
       handleSelectionChange(val) {
        ...
        Calculate(){
          ...
          if(this.multipleSelection.length>5){
           ...
           if(this.curveFields===""){
             this.$message.warning("曲线拟合自变量不能为空");
             return;
          }
          var param = {};
          let ids=[];
          ...
          param.curveFields.push(this.curveFields);
