                     ...
                     <el-col :span="12">
                          ...
                          <el-form label-width="120px">
                              ...
                              <el-form-item label="联系函数:" >
                               ...
                               <el-form-item label="应变量之间相关类型:" >
                                <el-select v-model="fieldRelation" placeholder="请选择..." >
                                      <el-option
                                        v-for="(item, idx) in geeTypes"
                                        :key="idx+1"
                                        :label="item.name"
                                        :value="idx+1">
                                      </el-option>
                              ...
                              <el-form-item label="暴露变量:" >
                                <el-select v-model="exposedField" placeholder="请选择.." >
                                      <el-option
                                        v-for="item  in dataColumns"
                                        :key="item.id"
                                        :label="item.rem"
       ...
       handleSelectionChange(val) {
        ...
        Calculate(){
          ...
          if(this.exposedField===""){
             this.$message.warning("暴露变量不能为空");
             return;
          }
          if(this.fieldRelation===""){
             this.$message.warning("应变量相关类型不能为空");
             return;
          }
          ...
          param.exposedField=this.exposedField;
          param.fieldRelation=this.fieldRelation;
